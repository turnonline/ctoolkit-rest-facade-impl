 ...
 */
class UpdateIdentificationImpl<T>
        implements UpdateIdentification<T>
{
    private final RestFacadeAdapter adapter;

    private final T resource;

    UpdateIdentificationImpl( @Nonnull RestFacadeAdapter adapter, @Nonnull T resource )
    {
    ...
    {
        return adapter.internalUpdate( resource, identifier, null );
    }

    @Override
    public PayloadRequest<T> identifiedBy( @Nonnull String identifier )
    {
        return adapter.internalUpdate( resource, new Identifier( identifier ), null );
    }
