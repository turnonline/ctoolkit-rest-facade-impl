 ...
 * (identity toolkit cookie {@link Identity#GTOKEN}), if any, via Authorization header.
 *
 * @author <a href="mailto:aurel.medvegy@ctoolkit.org">Aurel Medvegy</a>
 */
@Singleton
public class IdentityTokenAuthHeaderSubscriber
{
    /*
    ...
    @Inject
    public IdentityTokenAuthHeaderSubscriber( EventBus eventBus, Provider<HttpServletRequest> provider )
    {
